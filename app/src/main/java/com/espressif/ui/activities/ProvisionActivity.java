...
public class ProvisionActivity extends AppCompatActivity {
    ...
    private String mesh_softap_ssid, mesh_softap_password = "";
    private int mesh_id;
    ...
    private void doMeshliteSync() {
        Log.d("Meshlite",  "doMeshliteSync");
        SharedPreferences sharedPreferences = getSharedPreferences(AppConstants.ESP_PREFERENCES, MODE_PRIVATE);
        MessengeHelper.setMesh_id(Integer.valueOf(sharedPreferences.getString("ESP_MESH_LITE_ID", "77")));
        MessengeHelper.setMesh_softap_ssid(sharedPreferences.getString("ESP_MESH_LITE_SSID", ""));
        MessengeHelper.setMesh_softap_password(sharedPreferences.getString("ESP_MESH_LITE_PASSWORD", ""));
        MessengeHelper.setMesh_node_actor(sharedPreferences.getBoolean("mesh_root_mode", true));
    }
