...
- 避免与 mesh lite 协议 为 1.x 版本的设备发生融合 ([6a96fc0](https://github.com/espressif/esp-mesh-lite/commit/6a96fc063be3f46e6cc855848fb1a0caa4afc429))
...
- 优化 Station 断开后，mesh lite 内部的扫描时间 ([f1343a0](https://github.com/espressif/esp-mesh-lite/commit/f1343a0b9b8a72fee5cd106c173ea4cc03ac3dbb))
...
- 修复调用 esp_mesh_lite_disconnect 后，偶现仍触发 Wi-Fi 重连的问题 ([f1343a0](https://github.com/espressif/esp-mesh-lite/commit/f1343a0b9b8a72fee5cd106c173ea4cc03ac3dbb))
